...
#    amrdata.refinement_ratios_t = [2, 2, 2, 3, 3, 4, 4, 2]
    ...
    rundata.gaugedata.gauges.append([1,-74.013,40.7,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # 8516945 Kings point gauge
    rundata.gaugedata.gauges.append([2,-73.77,40.81,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # 8510560 Montauk, NY
    rundata.gaugedata.gauges.append([3,-71.96,41.04833,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # 8467150 Bridgeport, CT
    rundata.gaugedata.gauges.append([4,-73.1816666667,41.1733333333,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # 8465705 New Haven, CT
    rundata.gaugedata.gauges.append([5,-72.915152,41.2235,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
    # 8461490 New London, CT
    rundata.gaugedata.gauges.append([6,-72.09,41.3716666667,
                                     rundata.clawdata.t0,
                                     rundata.clawdata.tfinal])
...
def setgeo(rundata):
    ...
    ike.time_offset = datetime.datetime(2012, 10, 29, 23, 30)
