...
df = pd.read_csv(r'/opt/src/clawpack_src/clawpack-v5-9-0/geoclaw/scratch/4.storm', delimiter='     ', skiprows=3, header = None)
...
#     sandy.time_offset = datetime.datetime(2012, 10, 29, 23, 30)
    ...
    data.storm_file = os.path.join(scratch_dir, "4.storm")
