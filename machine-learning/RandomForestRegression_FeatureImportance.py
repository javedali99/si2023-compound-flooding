...
for csv_file in csv_files:
    ...
    rf_model = RandomForestRegressor(n_estimators=50, max_depth=5, min_samples_split=10, random_state=5, n_jobs=-1)
...
output_file = 'feature_importance_results_RF_10.csv'
