...
for csv_file in csv_files:
    ...
    mlp_model = MLPRegressor(hidden_layer_sizes=(100, 100), activation='identity', solver='lbfgs', random_state=5)
    
    # Perform cross-validation and calculate mean squared error
    cv_scores = cross_val_score(mlp_model, X_train, y_train, cv=10, scoring='neg_mean_squared_error',error_score=np.nan)
...
output_file = '/mh1/fyarveysi/SummerInstitude/RUNs_Result/feature_importance_results_MLP.csv'
